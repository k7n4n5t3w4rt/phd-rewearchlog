...
- "Web of Things": In the same way the Web (application layer) is a layer of shared protocols for the Internet (network layer), the Web of Things is a term that describes the proposed standards for an application layer that simplifies the creation of applications for the Internet of Things. There are a few competing specication candidates, including one from Mozilla (Mozilla IoT 2019)
