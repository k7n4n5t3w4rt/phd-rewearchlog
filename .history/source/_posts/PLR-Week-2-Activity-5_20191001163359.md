...
- "World space": A term from spatial computing (c.1997) and frequently found in technical documentation of 3D programming frameworks, eg: "Returns a vector representing the position of the object in world space."
...
- "Cyborg": Literally, part human, part machine. Metaphorically (or not?) a description of the "post-human" state.
