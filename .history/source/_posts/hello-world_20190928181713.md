...
Locative art is a practice bound to the technical fields described above and is concerned with how we interact with information using network technology in a way that is primarily spatial and contextual - and closely bound to our physical world in a way that is the converse of how similar practices focused on "virtual-reality" are not.
