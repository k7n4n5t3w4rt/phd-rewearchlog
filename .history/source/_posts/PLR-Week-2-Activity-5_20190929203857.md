...
- "Machine Learning": Machine learning turns data into information. Applied statistics, essentially. Algorithms applied to data to generate insights and support decision-making. The term covers the simpler algorithms such as linear algebra when applied to things like natural language processing, and also more complex structures like neural networks, used for things like image recognition. In a network context, machine learning functionality is being offered as a service, for example by Google Cloud Services, Microsoft Axure and Amazon Web Services.
